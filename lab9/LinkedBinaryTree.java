 ...
 * @version 1.00 03/28/2018
 * @throws IllegalStateException, IllegalArgumentException
 * @see java.util.Iterator, java.util.List, java.util.ArrayList
 */
public class LinkedBinaryTree<E> extends AbstractBinaryTree<E> {
  ...
  /**
   * Creates a new right child of Position p storing element e and returns 
   * its Position.
   *
   ...
   * @param  t1 a tree whose structure becomes the left child of p
   * @param  t2 a tree whose structure becomes the right child of p
   * @throws IllegalArgumentException if p is not a valid Position
   ...
   *
   * @return an array list of the elements in preorder.
   */
  ...
  /**
   * A recursive method to perform preorder traversal.
   *
   * @param v the position of the start node
   ...
   *  
   * @return an array list of the elements in postorder.
   */
  ...
  /**
   * A recursive method to perform postorder traversal.
   *
   * @param v the position of the start node
   * @param l an array list
   */
